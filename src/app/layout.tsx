...
export const metadata: Metadata = {
  title: "Baphomet | CS2 Competitive Player",
  description: "Follow Baphomet's journey climbing CS2 ranks. Watch live streams, highlights, and gameplay analysis from a dedicated competitive player.",
  keywords: "CS2, Counter-Strike 2, esports, gaming, Twitch, competitive ranks",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Baphomet | CS2 Competitive Player",
    description: "Follow Baphomet's journey climbing CS2 ranks with daily streams and highlight clips.",
    type: "website",
    siteName: "Baphomet CS2"
  }
};
